                ...
                alertWithSwal.fire({
                    ...
                    html: (
                        <p
                            ...
                            Selamat Datang,
                            <span
                                className={`font-body font-semibold text-green-500`}>{` ${response?.data?.email.toUpperCase()} `}</span>
                        </p>
                    ),
                })
                setTimeout(() => {
                ...
                <div className='flex w-full flex-row items-center justify-center'>
                    ...
                    {isPasswordTyping && (
                        <button
                            ...
                            className='p-2 text-gray-600 transition duration-300 hover:text-primary-400'>
                            {showPassword ? (
                                <svg

...
// Card Data Manipulation Language
export default function CardDML({ material, cookies, progressDDL }) {
  const fetcher = async () => {
    const response = await axios.get(
      `/api/user/progress/data-manipulation-language`,
      {
        headers: {

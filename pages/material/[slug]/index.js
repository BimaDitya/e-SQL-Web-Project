	...
	return (
		<div className="max-width max-height">
			...
			<LazyMotion features={domAnimation}>
				<div className="flex flex-row pt-14 pb-6 px-12 space-x-2">
					{/* Kolom Kiri */}
					<m.div
						transition={{
							duration: 1,
						...
						className="z-30 w-3/5 p-2.5 h-max rounded-md backdrop-blur-sm bg-transparent border-2 border-gray-200"
					>
						<div className="font-head text-center text-gray-400 pb-1.5">
					...
					<div className="z-30 w-2/5 space-y-2">
						...
						<m.div
							...
							initial={{ opacity: 0, x: 100 }}
							animate={{ opacity: 1, x: 0 }}
							className="px-4 py-2.5 h-max rounded-md backdrop-blur-sm bg-transparent space-y-2 border-2 border-gray-200"
						>
							<p className="text-xl font-head font-semibold text-secondary-400">
								Tentang Materi
							</p>
							<p className="text-gray-500 font-body text-clip text-justify">
								{material.Desc}
							</p>
							<div className="bg-gray-100 flex flex-row py-2 px-4 space-x-2 rounded">
								<svg
									...
									className="w-6 h-6 border-primary-100"
								>
									<path
										strokeLinecap="round"

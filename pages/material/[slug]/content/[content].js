				...
				<div className="flex flex-row px-8">
					<div className="items-start h-full flex w-full justify-center">
						<m.div
							...
							className="z-30 w-full m-10 p-4 rounded-md backdrop-blur-sm bg-transparent border-2 border-gray-200"
						>
							<div className="flex flex-col font-body text-justify">
								<p className="text-2xl text-center px-12 pb-4 font-semibold font-head text-secondary-400">
									{contents.viewContent[0]?.Title}
								</p>
								<div className="prose max-w-none prose-strong:text-bold px-8 text-gray-600">
									<MDXContent />
								</div>
							</div>
						</m.div>

...
const AddMaterial = dynamic(() => import("@/components/Modal/AddMaterial"));
const EditMaterial = dynamic(() => import("@/components/Modal/EditMaterial"));
const DeleteMaterial = dynamic(
  () => import("@/components/Modal/DeleteMaterial"),
);
          ...
          <div className="flex w-full flex-row space-x-2">
            ...
            >
              <div className="h-max w-full">
                {/* Baris Atas */}
                <div className="flex w-full flex-row items-center justify-between rounded pb-2">
                      ...
                      <tbody className="bg-gray-50 font-body text-gray-500">
                        {Object.values(records).map((Rows, index) => (
                          ...
                          >
                            ...
                            <td className="max-w-xs px-2 py-1.5 text-center">

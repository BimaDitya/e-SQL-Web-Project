        ...
        <div className="flex flex-row space-x-4 px-8 py-12">
          ...
          <m.div
            ...
            className="z-30 h-max w-[25%] rounded-md border-2
						border-gray-200 bg-transparent backdrop-blur-sm"
          >
          ...
          <m.div
            ...
            initial={{ opacity: 0, x: 100 }}
            animate={{ opacity: 1, x: 0 }}
            className="z-30 h-max w-[75%] rounded-md border-2 border-gray-200 bg-transparent px-4 py-2.5 backdrop-blur-sm"
          >
            {/* Baris Atas */}

    ...
    <>
      ...
      <LazyMotion features={domAnimation}>
        <div className="columns-2 bg-white/50">
          {/* Left Columns */}
          <div className="ml-20 flex h-adaptive items-center justify-center">
            <m.div
              transition={{ duration: 0.5, type: "spring", stiffness: 50 }}
              initial={{ opacity: 0, x: -100 }}
              animate={{ opacity: 1, x: 0 }}
              className="z-30 rounded-md border-2 border-gray-200 bg-transparent px-12 py-8 shadow-lg backdrop-blur-sm"
            >
          ...
          <m.div
            ...
            initial={{ opacity: 0, x: 100 }}
            animate={{ opacity: 1, x: 0 }}
            className="flex h-adaptive items-center justify-center"
          >
